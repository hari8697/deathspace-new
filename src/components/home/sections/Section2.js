...
const Section2 = (props) => {
  ...
  return (
    <Section className="particle__section section__two" noPadding>
      {/* <div className=""> */}
      <AnimatePresence>
        {state && (
          <motion.div
          ...
          >
            ...
            >
              ...
              code. Oh, and I have a serious passion for making neat animations.
              Please have a look around & don't forget to play with the stars!
            </Paragraph>
          </motion.div>
        )}
      </AnimatePresence>
